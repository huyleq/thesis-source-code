...
las=lasio.read('../wells/177154098500_Orig+Edit+RckPhys.las')
kb=97
wdepth=75
depthlog=las['DEPTH']
depthlog=depthlog[np.isfinite(las['DT_ED1'])]
soniclog=las['DT_ED1'][np.isfinite(las['DT_ED1'])]

Age_depth=np.array([[0],[6.9199e3],[9.5231e3]]) 
mudweight=np.array([[8.9],[10.5],[11.1],[14.1],[14.8]])
muddepth=np.array([[1035],[7285],[12250],[14224],[15925]])
...
#ax5.invert_yaxis()
ax5.legend()
#plt.savefig('../Fig/RPTST143.pdf',bbox_inches='tight')
#plt.show()
...
ax4.legend()
plt.tight_layout()
#plt.savefig('../Fig/ppRPTST143.pdf',bbox_inches='tight')
f.suptitle('ST143')
plt.show()
