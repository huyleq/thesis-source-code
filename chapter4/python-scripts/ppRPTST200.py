...
las=lasio.read('../wells/177154042100_Orig+Edit+RckPhys.las')
kb=93
wdepth=131
depthlog=las['DEPTH']
depthlog=depthlog[np.isfinite(las['DT_ED4'])]
soniclog=las['DT_ED4'][np.isfinite(las['DT_ED4'])]

Age_depth=np.array([[0],[7.7944e3],[1.1877e4]]) 
mudweight=np.array([[10],[11.8],[12.6],[13.2],[13.5],[14.3],[15.4],[16.2],[16],[15.3],[16.8]])
muddepth=np.array([[3553],[6025],[9305],[10415],[10957],[11500],[12425],[13955],[14263],[15205],[15592]])
...
#ax5.invert_yaxis()
ax5.legend()
#plt.savefig('../Fig/RPTST200.pdf',bbox_inches='tight')
#plt.show()
...
ax4.legend()
plt.tight_layout()
#plt.savefig('../Fig/ppRPTST200.pdf',bbox_inches='tight')
f.suptitle('ST200')
plt.show()
