...
int main(int argc,char **argv){
    ...
    float *dtgbarQinv=new float[nxz]; read("Qinv",dtgbarQinv,nxz);

    float gbar;
    get_param("gbar",gbar);
    scale(dtgbarQinv,dt*gbar,nxz);
    ...
    viscoelastic_modeling_f(sx_wfld,sz_wfld,sxz_wfld,vx_wfld,vz_wfld,wavelet,c11,c13,c33,c44,buoy,dtgbarQinv,&g[0],&w[0],nx,nz,nt,npad,dxz,dt,islocxz,sampling_rate);
    ...
    delete []c11;delete []c13;delete []c33;delete []c44;delete []buoy; delete []dtgbarQinv;
    delete []wavelet;
