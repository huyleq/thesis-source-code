...
int main(int argc,char **argv){
 ...
 int nn=3*nnxz,mm=5,diagco=0,icall=0,iflag=0;
 float f;
...
//  float *geps=gvepsdel,*gdel=gvepsdel+nnxz,*gv=gvepsdel+2*nnxz;
  ...
  while(true){
   ...
   lbfgs(nn,mm,vnetadel,f,gvnetadel,diagco,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   lbfgs(nn,mm,vhepsdel,f,gvhepsdel,diagco,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   lbfgs(nn,mm,vhepseta,f,gvhepseta,diagco,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   lbfgs(nn,mm,vvhdel,f,gvvhdel,diagco,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   lbfgs(nn,mm,vnvhdel,f,gvnvhdel,diagco,diag,w,iflag,isave,dsave);
...
//  float *gvn=gvvnvh,*gvh=gvvnvh+nnxz,*gv=gvvnvh+2*nnxz;
  ...
  while(true){
   ...
   lbfgs(nn,mm,vvnvh,f,gvvnvh,diagco,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   lbfgs(nn,mm,c11c13c33,f,gc11c13c33,diagco,diag,w,iflag,isave,dsave);
