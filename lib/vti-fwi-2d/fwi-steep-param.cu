...
//  float *geps=gvepsdel,*gdel=gvepsdel+nnxz,*gv=gvepsdel+2*nnxz;
  ...
  while(true){
   ...
   steepest(nn,vepsdel,f,gvepsdel,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,vnetadel,f,gvnetadel,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,vhepsdel,f,gvhepsdel,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,vhepseta,f,gvhepseta,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,vvhdel,f,gvvhdel,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,vnvhdel,f,gvnvhdel,diag,w,iflag,isave,dsave);
...
//  float *gvn=gvvnvh,*gvh=gvvnvh+nnxz,*gv=gvvnvh+2*nnxz;
  ...
  while(true){
   ...
   steepest(nn,vvnvh,f,gvvnvh,diag,w,iflag,isave,dsave);
  ...
  while(true){
   ...
   steepest(nn,c11c13c33,f,gc11c13c33,diag,w,iflag,isave,dsave);
