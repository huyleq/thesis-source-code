...
int main(int argc,char **argv){
 ...
 float **fgcij_server=new float*[nserver]();
...
//     cout<<"command1 "<<command1[i]<<endl;
 ...
 while(true){
  ...
  if(shotid.size()>0) objFuncGradientCij_cluster(fgcij,nx,ny,nz,shotid,pct,max_shot_per_job,icall,cluster_command1);
 ...
 delete []vepsdel;delete []cij;delete []gvepsdel;delete []fgcij;
 delete []m;
